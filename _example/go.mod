module github.com/github.com/lumigo-io/go-tracer-beta/_example

go 1.17

require (
	github.com/aws/aws-lambda-go v1.28.0
	github.com/lumigo-io/go-tracer-beta v0.1.1
)
...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/github.com/aws/aws-sdk-go-v2/otelaws v0.27.0 // indirect
